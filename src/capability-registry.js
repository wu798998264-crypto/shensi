...
const entries = [
  ...
  descriptor({ capabilityId: "other_capability", kind: "advisor", phases: ["prewrite", "produce", "postwrite"], stages: ["planning", "response", "creative", "revision", "quick-revision", "evaluation", "visual-generation", "visual-revision"], stackPolicy: "stack", stackKey: "other_capability", budgetClass: "advisor", autoEligible: false }),
