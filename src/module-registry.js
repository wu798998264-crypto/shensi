...
export const DEFAULT_CUSTOM_SKILL_SLOTS = Object.freeze([
  Object.freeze({
    ...
    name: "爆款扫榜",
    description: "按用户明确指定的平台、榜单和范围采集公开榜单样本，形成可追溯的市场观察报告。",
    capabilityBoundary: "只定义扫榜方法、字段、质量规则与报告格式；真实访问、执行、恢复、保存和权限由可信内核控制。默认不登录、不读取私人数据、不写入作品。",
    workspaceModes: freezeList(["general"]),
    capabilities: freezeList(["market_research", "ranking_scan", "knowledge_reference"]),
    slotType: "single",
    triggerKeywords: freezeList(["爆款扫榜", "扫榜", "榜单分析", "市场榜单", "起点榜单", "晋江榜单"]),
