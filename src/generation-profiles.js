...
// GPT Image is provided by the built-in aggregate API. Retire only the two
// historical system aliases; user-created OpenAI/API/CLI profiles must remain
// untouched even when they use the same provider or model.
