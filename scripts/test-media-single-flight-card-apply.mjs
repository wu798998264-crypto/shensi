...
assert.match(app, /const userStopped = Boolean\([^\n]+\) && !failureNeedsCard/u, "没有终态厂商失败证据的已停止任务不得重建卡片");
assert.match(app, /if \(userStopped \|\| targetWasDeleted\)/u, "已停止且没有迟到终态失败证据、或已删除的任务不得重建卡片");
