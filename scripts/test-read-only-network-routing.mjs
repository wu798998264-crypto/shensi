...
import { buildAdaptiveTaskRoute, classifyRequestMode } from "../src/request-routing.js";

const instruction = "请真实联网查询 OpenAI Codex 当前最新版本。不要保存、写入或修改文档，只回答联网结果并附来源。";
const route = classifyRequestMode({ text: instruction, workspaceKind: "project", targetDocumentId: "chapter-1" });
